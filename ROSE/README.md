...
## gen_repeat_db
./rpc_client ./database/my.cdb 5 1 keyword 10000 10 benchmark_client_rose_gen_db.out
./rpc_client ./database/my.cdb 5 1 keyword 10000 30 benchmark_client_rose_gen_db.out
./rpc_client ./database/my.cdb 5 1 keyword 10000 50 benchmark_client_rose_gen_db.out
./rpc_client ./database/my.cdb 5 1 keyword 10000 70 benchmark_client_rose_gen_db.out
./rpc_client ./database/my.cdb 5 1 keyword 10000 90 benchmark_client_rose_gen_db.out
...
#update_delete
## path of database, flag, number of threads, number of entries, path of logfile
./rpc_client ./database/my.cdb 4 1 keyword 10000 10 benchmark_client_rose.update_del.out
./rpc_client ./database/my.cdb 4 1 keyword 10000 30 benchmark_client_rose.update_del.out
./rpc_client ./database/my.cdb 4 1 keyword 10000 50 benchmark_client_rose.update_del.out
./rpc_client ./database/my.cdb 4 1 keyword 10000 70 benchmark_client_rose.update_del.out
./rpc_client ./database/my.cdb 4 1 keyword 10000 90 benchmark_client_rose.update_del.out
```
