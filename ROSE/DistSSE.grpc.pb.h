...
class RPC final {
 public:
  ...
  typedef WithAsyncMethod_setup<WithAsyncMethod_search<WithAsyncMethod_search_rose<WithAsyncMethod_update<WithAsyncMethod_batch_update<WithAsyncMethod_batch_update_rose<WithAsyncMethod_cache<WithAsyncMethod_batch_cache<Service > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_setup<WithCallbackMethod_search<WithCallbackMethod_search_rose<WithCallbackMethod_update<WithCallbackMethod_batch_update<WithCallbackMethod_batch_update_rose<WithCallbackMethod_cache<WithCallbackMethod_batch_cache<Service > > > > > > > > CallbackService;
  ...
  typedef WithSplitStreamingMethod_search<WithSplitStreamingMethod_search_rose<Service > > SplitStreamedService;
  typedef WithStreamedUnaryMethod_setup<WithSplitStreamingMethod_search<WithSplitStreamingMethod_search_rose<WithStreamedUnaryMethod_update<WithStreamedUnaryMethod_cache<Service > > > > > StreamedService;
};
